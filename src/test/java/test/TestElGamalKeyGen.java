...
/**
 * This test class is from the Bouncy Castle test suite.
 */
public class TestElGamalKeyGen extends TestCase {
        ...
        throws Exception
    {
        ...
        if (!java.util.Arrays.equals(out, maxInput))
        {
        ...
        if (!java.util.Arrays.equals(in, out2))
        {
        ...
        throws Exception
    {
        ...
        if (!java.util.Arrays.equals(encodeParams, encodeParams_2))
        {
	...
	public void testElGamalKeyGen() {
		
		try {
			java.security.Security.addProvider(new BouncyCastleProvider());
			
			debug.Debug.println(1, "Testing Bit Length 512");
			testGP(512, 0, g512, p512);
			debug.Debug.println(1, "Testing Bit Length 768");
	        testGP(768, 0, g768, p768);
	        debug.Debug.println(1, "Testing Bit Length 1024");
	        testGP(1024, 0, g1024, p1024);

	        debug.Debug.println(1, "Testing Bit Length 512 with X bit length of 64");
	        testGP(512, 64, g512, p512);
	        debug.Debug.println(1, "Testing Bit Length 768 with X bit length of 128");
	        testGP(768, 128, g768, p768);
	        debug.Debug.println(1, "Testing Bit Length 1024 with X bit length of 256");
