 ...
 */
public class TestSecretKeyPacketSimple extends TestCase {
    ...
    public void testSKPSimpleWithRSAAndIDEAAndMD5()
    {
    	assertTrue( 
    			doTest( PublicKeyAlgorithmSettings.RSA_ENCRYPTSIGN, 
	    			SymmetricAlgorithmSettings.IDEA, 
	    			HashAlgorithmSettings.MD5 ) 
	    );
    }
