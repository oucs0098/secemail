...
public class AddKeySource extends javax.swing.JDialog {
    ...
    public AddKeySource(java.awt.Frame parent, boolean modal, String classlistfile) {
        ...
        try {
            BufferedReader r = new BufferedReader(new InputStreamReader(
            		this.getClass().getResourceAsStream(classlistfile)));

            while (r.ready()) {
            	String type = r.readLine();
            	Class c = Class.forName(type);
            	typeMap.put(((KeyHandler)c.newInstance()).getDescription(), type);
            }
            r.close();
    ...
    private void initComponents() {
        ...
        typeFile.add(jButton3);

        jPanel2.add(typeFile, java.awt.BorderLayout.NORTH);
        ...
        jPanel2.add(typeServer, java.awt.BorderLayout.SOUTH);
...
// TODO add your handling code here:
    ...
    private void doComboBox() {
        try {
        	...
        	String type = (String)typeMap.get(jComboBox1.getSelectedItem());
    ...
    /** Returns the populated key handler */
    public KeyHandler getReturnValue() {
        return returnValue;
    }
    
    /** @return an array of readable key handler types */
    private Object[] getTypes() {
    	return typeMap.keySet().toArray();
    }
...
// Add your handling code here:
        try {
            ...
            if (o instanceof KeyFile) {
                ...
                kf.setFile(StringHelper.escapeWinPath(jTextField1.getText()));
                returnValue = kf;
            } else if (o instanceof KeyServer) {
                KeyServer ks = (KeyServer)o;
                ks.setServer(jTextField3.getText(),
    ...
    // Object to hold the mappings between class name and displayable name
